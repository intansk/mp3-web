            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <form class="forms-sample" method="POST" action="myForm">
                        ...
                        <input type="text" class="form-control" name="nama_pelanggan" id="nama_pelanggan" placeholder="Username">
                        </div>
                        ...
                        <input type="date" class="form-control" name="tanggal_keluhan" id="tanggal_keluhan" placeholder="Tanggal">
                        </div>
