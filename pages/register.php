...
if (!isset($_COOKIE['ingat_saya'])) {
    // echo "<script>alert('Cookie ingat_saya sudah ada.');</script>";
  } else {
    $_SESSION['sudah_login'] = true;
    // echo "<script>alert('Cookie ingat_saya belum ada.');</script>";
  }
            ...
            <div class="main-panel">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Welcome Back, Kuma Car Spa Staff!</h3>
                                </div>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card tale-bg">
                                <div class="card-people mt-auto">
                                    <img src="../images/img car wash.jpg" alt="Kuma Car Spa">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2021 by Intan Melani Sukma</span>
