                    ...
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Pendaftaran Pencucian Kendaraan</h4> <br>
                                <form class="forms-sample" accept="tambah-cucian.php" method="POST">
                                  <div class="form-group">
                                      ...
                                      <select required class="form-control" id="kode_pegawai" name="kode_pegawai">
                                          <option disabled selected value="">Pilih Kode Pegawai</option>
                                          <?php
                                  ...
                                  <div class="form-group">
                                      ...
                                      <select required class="form-control" id="kode_pelanggan" name="kode_pelanggan">
                                          <option disabled selected value="">Pilih Kode Pelanggan</option>
                                          <?php
                                ...
                                <!-- <div class="form-group">
                                    <label for="kode_pegawai">Kode Pegawai</label>
                                    <input required type="text" name="kode_pegawai" class="form-control" id="kode_pegawai">
                                </div>

                                <div class="form-group">
                                    <label for="kode_pelanggan">Kode Pelanggan</label>
                                    <input required type="text" name="kode_pelanggan" class="form-control" id="kode_pelanggan">
                                </div> -->
