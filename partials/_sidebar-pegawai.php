    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="../pages/tambah-cucian.php">Pendaftaran antrian</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="tables-layanan">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"><a class="nav-link" href="../pages/layanan.php">Layanan cuci</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="../pages/lihat-cucian.php">Antrian</a></li>
                    <li class="nav-item"> <a class="nav-link" href="../pages/history.php">Riwayat</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="pembayaran">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="../pages/pembayaran.php">Bayar cucian</a></li>
                </ul>
            </div>
        </li>
        ...
        <!-- <li class="nav-item">
            ...
            <div class="collapse" id="contact">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="../pages/umpan-balik.php">Umpan balik</a></li>
                </ul>
            </div>
        </li> -->
        ...
        <!-- <li class="nav-item">
            ...
            <div class="collapse" id="auth">
                ...
                <li class="nav-item"> <a class="nav-link" href="../pages/login-pegawai.php"> Login Pegawai </a></li>
                <li class="nav-item"> <a class="nav-link" href="../pages/login-pelanggan.php"> Login Pelanggan </a></li>
                </ul>
            </div>
        </li> -->
    </ul>
